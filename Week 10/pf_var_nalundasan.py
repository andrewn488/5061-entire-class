...
def plot_scenario(profits, moves):
    ...
    width = 0.5       # width of bars. they look thin in canvas. width = 1 is touching other bars
...
if __name__ == '__main__':
    ...
    # produce_report('test4') # andrew created another file for test4 independently 
